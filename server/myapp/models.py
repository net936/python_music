...
class Thing(models.Model):
    ...
    source = models.FileField(upload_to='source/', null=True)
    description = models.TextField(max_length=1000, blank=True, null=True)
    geshou = models.CharField(max_length=50, blank=True, null=True)
    yuyan = models.CharField(max_length=50, blank=True, null=True)
    zhuanji = models.CharField(max_length=50, blank=True, null=True)
    faxingfang = models.CharField(max_length=50, blank=True, null=True)
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
